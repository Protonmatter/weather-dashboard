...
const actionClass = glassClass("control", {
  interactive: true,
  className: "glass-control inline-flex items-center gap-1.5 rounded-full px-3 text-xs disabled:opacity-50",
});
            ...
            return (
              ...
              >
                <button
                  ...
                  className="glass-control flex min-w-0 items-center gap-2 px-3 py-2 text-left"
                ...
                <button
                  ...
                  onClick={() => onRemove(id)}
                  disabled={pending}
                  className="glass-divider glass-control px-2.5 text-white/50 hover:text-white disabled:opacity-40"
